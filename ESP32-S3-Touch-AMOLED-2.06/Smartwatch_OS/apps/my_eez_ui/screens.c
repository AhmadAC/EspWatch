...
void create_screen_main() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0x000000), LV_PART_SCROLLBAR | LV_STATE_SCROLLED);
    {
        lv_obj_t *parent_obj = obj;
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.obj0 = obj;
            lv_obj_set_pos(obj, 154, 288);
            ...
            create_user_widget_app_icon(obj, 2);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, 100);
            lv_imagebutton_set_src(obj, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &img_cam, NULL);
        ...
        }
        {
            // app_tools_icon
            lv_obj_t *obj = lv_imagebutton_create(parent_obj);
            objects.app_tools_icon = obj;
            lv_obj_set_pos(obj, 280, 90);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, 100);
            lv_imagebutton_set_src(obj, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &img_spanner, NULL);
        ...
        }
        {
            // label_spanner
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.label_spanner = obj;
            lv_obj_set_pos(obj, 312, 190);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_remove_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_scrollbar_mode(obj, LV_SCROLLBAR_MODE_OFF);
            lv_obj_set_scroll_dir(obj, LV_DIR_NONE);
            lv_label_set_text_static(obj, "Tools");
        }
    }
