...
void init_es8311_codec(uint32_t sample_rate, uint16_t bits_per_sample) {
    ...
    // 2. Configure Clock Scheme using calculated master clock coefficients
    ...
    // 5. Set default output volume (~90%)
