...
extern "C" void app_main(void)
{
...

    {
        ...
        /* ========================================================== */
        /* --- MANUALLY INSTALL OUR CUSTOM APPS --- */
        /* ========================================================== */
        AppClock *app_clock = new (std::nothrow) AppClock();
        ESP_UTILS_CHECK_NULL_EXIT(app_clock, "Create AppClock failed");
        ESP_UTILS_CHECK_FALSE_EXIT(phone->installApp(app_clock), "Install AppClock failed");

        AppSettings *app_settings = new (std::nothrow) AppSettings();
        ESP_UTILS_CHECK_NULL_EXIT(app_settings, "Create AppSettings failed");
        ESP_UTILS_CHECK_FALSE_EXIT(phone->installApp(app_settings), "Install AppSettings failed");
        /* ========================================================== */
